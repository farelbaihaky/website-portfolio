            ...
            <div className="container">
                ...
                <div className="projects-grid">
                    {projects.map((project) => (
                        <div
                            key={project.id}
                            className={`project-card glass-card project-card--${project.accentColor}`}
                        >
                            {/* Top accent bar */}
                            ...
                            <div className="project-card__header">
                                <div className="project-card__title-row">
                                    ...
                                    <div>
                                        <h3>{project.title}</h3>
                                        <span className="badge project-card__badge">{project.category}</span>
                                    </div>
                                </div>
                            ...
                            {/* Stats */}
                            <div className={`project-card__stats project-card__stats--${project.accentColor}`}>
                            ...
                            <div className="project-card__tech">
                                {project.technologies.map((tech, i) => (
                                    <span key={i} className={`tech-tag tech-tag--${project.accentColor}`}>{tech}</span>
                                ))}
                            </div>
                            ...
                            <div className="project-card__footer">
                                ...
                                <button
                                    className={`fp-details-btn fp-details-btn--${project.accentColor}`}
